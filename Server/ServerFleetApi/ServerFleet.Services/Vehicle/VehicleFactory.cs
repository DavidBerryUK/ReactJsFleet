    ...
    public class VehicleFactory : IVehicleFactory
    {
        ...
        private IEnumerable<VehicleModel> GetVolkswagen()
        {
            var data = new List<VehicleModel>
            {
                ...
                new VehicleModel {Registration  = "DN53 PQB", Make = "Volkswagen",Model = "Golf", Colour = "Grey", Mileage = 24022, Fuel="Diesel", Transmission="Automatic", Doors = 3, BodyType="Hatchback", Mpg = 64.3},
                new VehicleModel {Registration  = "DN14 WF2", Make = "Volkswagen",Model = "Golf", Colour = "Red", Mileage = 24077, Fuel="Petrol", Transmission="Manual", Doors = 3, BodyType="Hatchback", Mpg = 53.3},
